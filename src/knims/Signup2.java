...
private void connectToDatabase() {
        try {
            connection = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/Knims", "root", "Wi0797563115#");
 ...
 // Method to handle sign-up
   ...
   if (!password.equals(confirmPassword)) {
    ...
    String hashedPassword = hashPassword(password);
        ...
        // SQL query
        String query = "INSERT INTO Official(ID, Official_Rank, Password) VALUES (?, ?, ?)";
    ...
    private void initComponents() {
        ...
        jLabel5.setText("ENTER YOUR USER ID: ");
        ...
        jLabel2.setText("KENYA NATIONAL ID MANAGEMENT SYSTEM");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/flat,750x,075,f-pad,750x1000,f8f8f81.png"))); // NOI18N
